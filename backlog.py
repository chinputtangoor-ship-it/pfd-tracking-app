    ...
    # ==========================================
        ...
        if not p_df.empty:
            ...
            if line_col and status_col and batch_col:
                ...
                missing = [n for n, c in [("line", line_col), ("batch status", status_col), ("batch", batch_col)] if
                           not c]
        ...
        if not b_df.empty:
            ...
            if line_col_b and batch_col_b:
                ...
                if not match_rows.empty:
                    ...
                    old_print = int(
                        pd.to_numeric(last_record.get(print_col, 0), errors='coerce') or 0) if print_col else 0
